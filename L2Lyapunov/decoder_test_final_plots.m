...
scatter(ax1, l2,0,'red','filled','diamond','DisplayName','L_2');
...
axis(ax1,'equal');
xlim(ax1,[0.2 1.7]); ylim(ax1,[-0.75 0.75]);
...
set(ax1, 'LineWidth', 2, 'FontSize', 20, 'FontWeight', 'bold', 'TickLabelInterpreter', 'latex');
axis(ax1,'equal');
xlim(ax1,[0.8 1.3]); ylim(ax1,[-0.25 0.25]);
...
set(ax1, 'LineWidth', 2, 'FontSize', 20, 'FontWeight', 'bold', 'TickLabelInterpreter', 'latex');
axis(ax1,'equal');
xlim(ax1,[1.1 1.2]); ylim(ax1,[-0.05 0.05]);
...
scatter(l2,0,'red','filled','diamond','DisplayName','L_2');
moon_radius = const.moon_R;
[Xm,Ym,Zm] = sphere(50);
Xm = moon_radius*Xm + (1-mu);
Ym = moon_radius*Ym;
