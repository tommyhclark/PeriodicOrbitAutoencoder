...
%%%%%%%%%% Must Fix %%%%%%%%%%%%%%%%%%%%%%
xShift = const.l2;
l2 = const.l2; % Used for plotting L2
...
for ii = 1:100:Norb
    ...
    scatter(states_out(:,1), states_out(:,2), ...
             20, orbitColor, 'filled');
    plot([states(:,1);states(1,1)],[states(1:end,2);states(1,2)],"Color",orbitColor,"LineWidth",1e-10)
end
...
for ii = 1:length(not_corrected_idxs)
    ...
    scatter(states(:,1),states(:,2),20,"red")
end
...
xlabel("X")
ylabel("Y")
title("AI Generated $L_2$ Lyapunov Family","Interpreter","latex")
axis equal
